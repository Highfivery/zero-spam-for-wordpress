...
// $is_network, $api_monitoring, $zerospam_enabled, $zerospam_license,
// $license_valid, $license_status_message, $data.
?>

<div class="zerospam-dashboard-widget" data-is-network="<?php echo $is_network ? '1' : '0'; ?>">

	<?php // Database Table Missing Notice. ?>
	<?php if ( ! empty( $data['table_missing'] ) ) : ?>
		<div class="zerospam-notice zerospam-notice-warning">
			<div class="zerospam-notice-icon">
				<span class="dashicons dashicons-database"></span>
			</div>
			<div class="zerospam-notice-content">
				<h4><?php esc_html_e( 'Database Table Not Found', 'zero-spam' ); ?></h4>
				<p><?php esc_html_e( 'The spam log table could not be found. Try deactivating and reactivating the plugin to rebuild database tables.', 'zero-spam' ); ?></p>
				<p>
					<a href="<?php echo esc_url( admin_url( 'options-general.php?page=wordpress-zero-spam-settings' ) ); ?>" class="button button-small">
						<?php esc_html_e( 'Go to Settings', 'zero-spam' ); ?>
					</a>
				</p>
			</div>
		</div>
		...
		<div class="zerospam-stats-grid">
			<?php if ( $is_network ) : ?>
				<div class="zerospam-stat-card">
					...
					<div class="zerospam-stat-content">
						<div class="zerospam-stat-value" data-stat="total_blocked"><?php echo esc_html( number_format( $data['total_blocked'] ) ); ?></div>
				...
				<div class="zerospam-stat-card">
					...
					<div class="zerospam-stat-content">
						<div class="zerospam-stat-value" data-stat="total_sites"><?php echo esc_html( number_format( $data['total_sites'] ) ); ?></div>
				...
				<?php if ( ! empty( $data['api_usage'] ) ) : ?>
					<div class="zerospam-stat-card">
						...
						<div class="zerospam-stat-content">
							<div class="zerospam-stat-value" data-stat="api_remaining"><?php echo esc_html( number_format( $data['api_usage']['remaining'] ) ); ?></div>
			...
			<?php else : ?>
				...
				<div class="zerospam-stat-card">
					...
					<div class="zerospam-stat-content">
						<div class="zerospam-stat-value" data-stat="unique_ips"><?php echo esc_html( number_format( $data['unique_ips'] ) ); ?></div>
				...
				<div class="zerospam-stat-card">
					...
					<div class="zerospam-stat-content">
						<div class="zerospam-stat-value" data-stat="active_days"><?php echo esc_html( number_format( $data['active_days'] ) ); ?></div>
	...
	<div class="zerospam-widget-footer">
		...
		<?php if ( current_user_can( 'manage_options' ) && empty( $data['table_missing'] ) ) : ?>
			<button type="button" class="zerospam-refresh-btn button button-small">
...
<script type="text/javascript">
	var zerospamChartData = {
		trendData: <?php echo wp_json_encode( ! empty( $data['trend_data'] ) ? $data['trend_data'] : array() ); ?>,
