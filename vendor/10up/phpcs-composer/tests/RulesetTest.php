<?php
/**
 * Tenup Coding Standard.
 *
 * @package PhpcsComposer
 * @license https://opensource.org/licenses/MIT MIT
 */

namespace PhpcsComposer;
...
class RulesetTest {
	...
	/**
	 * Name of the ruleset e.g. TenUpDefault.
	 *
	 * @var string
	 */
	private $ruleset;
	...
	/**
	 * Name of the ruleset directory e.g. 10up-Default.
	 *
	 * @var string
	 */
	private $ruleset_directory;
	...
	/**
	 * Mapping of directory names to ruleset names.
	 *
	 * @var string[]
	 */
	private $directory_mapping = [
		'TenUpDefault' => '10up-Default',
	];
